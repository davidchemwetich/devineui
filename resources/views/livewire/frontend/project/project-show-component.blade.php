        ...
        <div class="relative px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
                <div>
                    ...
                    <p class="mt-6 text-xl text-green-100 leading-relaxed">
    ...
    <div class="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="lg:grid lg:grid-cols-3 lg:gap-12">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-6">Latest Update</h2>
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            <div class="text-sm text-gray-500 mb-2">
                                {{ $project->latest_update_date ? $project->latest_update_date->format('F j, Y') : 'Recent' }}
                            </div>
                            <p class="text-gray-700 leading-relaxed">{{ $project->latest_update }}</p>
                        </div>
                    </div>
                </div>
                @endif
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-6">Share This Project</h2>
            ...
            <div class="mt-12 lg:mt-0">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 mb-8 sticky top-8">
                    <h3 class="text-xl font-bold text-gray-900 mb-6">Support This Project</h3>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex justify-between text-sm text-gray-600 mt-2">
                            ...
                            <span>KSh {{ number_format($project->goal_amount - $project->raised_amount, 2) }} remaining</span>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <button class="block w-full text-center px-6 py-3 border-2 border-[#008000] text-[#008000] font-semibold rounded-lg hover:bg-[#008000] hover:text-white transition-colors duration-200">
                            Share Project
                        </button>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-[#000fff]">{{ number_format($project->progress_percentage, 1) }}%</span>
                        </div>
                        <div class="flex justify-between">
        ...
        <div class="px-4 mx-auto max-w-4xl sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8 lg:p-12">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <!-- Donation Options -->
                    <div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Choose Your Donation Method</h3>
                        
                        <div class="space-y-4">
                            <!-- PayPal Option -->
                            <div class="border border-gray-200 rounded-lg p-4 hover:border-[#000fff] transition-colors duration-200">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        <div class="w-12 h-12 bg-[#000fff] rounded-lg flex items-center justify-center mr-4">
                            ...
                            <!-- M-Pesa Option -->
                            <div class="border border-gray-200 rounded-lg p-4 hover:border-green-500 transition-colors duration-200">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                        ...
                        <div class="mt-8 p-4 bg-gray-50 rounded-lg">
                            <p class="text-sm text-gray-600 mb-2">
                                <strong>Important:</strong> When making your donation, please include the project reference: 
                    ...
                    <!-- Impact Information -->
                    <div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Your Impact</h3>
                        
                        <div class="space-y-6">
                            <div class="bg-gray-50 rounded-lg p-6">
                                <h4 class="font-semibold text-gray-900 mb-2">Current Progress</h4>
                            ...
                            <div class="bg-gray-50 rounded-lg p-6">
                                <h4 class="font-semibold text-gray-900 mb-3">How Your Donation Helps</h4>
                                <ul class="space-y-2 text-sm text-gray-700">
                                    <li class="flex items-start">
                                        <svg class="w-4 h-4 text-[#008000] mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="text-center p-4 bg-gradient-to-r from-[#008000]/10 to-green-100 rounded-lg">
                                <p class="text-sm text-gray-700 italic">
                                    "Every donation, no matter the size, brings us closer to our goal and makes a meaningful difference in our community."
                                </p>
                            </div>
                        </div>
                    </div>
