    ...
    <div class="flex flex-wrap justify-center gap-8">
        ...
        <div
            ...
            <div class="relative overflow-hidden aspect-w-4 aspect-h-3">
                <img src="{{ $member->getProfileImageUrlAttribute() }}" alt="{{ $member->name }}"  onerror="this.onerror=null;this.src='{{ asset('images/citwam/avatar.jpeg') }}';"
            ...
            <div class="p-6">
                ...
                {{-- Special Bio for Bishop Dr. Moses Kisorio --}}
                @if($member->name == "Bishop Dr. Moses Kisorio" || $member->name == "Dr. Moses Kisorio" || $member->name == "Moses Kisorio")
                <div class="mt-4 pt-4 border-t border-gray-200">
                    <div class="prose prose-sm max-w-none">
                        <p class="mb-2">Bishop Dr. Moses Kisorio is the founder of Christ Is the Way Ministries. Together with his wife Anne, they have led the church since its founding in 2000, guiding its growth and expansion throughout Kenya.</p>
                        
                        <p class="mb-2">Under his leadership, CITWAM has grown from a small church to a ministry with regional presence in multiple counties including Turkana, West-Pokot, Nandi, Migori, Machakos, Makueni, and Isiolo.</p>
                        
                        <p class="mb-2">Bishop Kisorio emphasizes the importance of a holistic gospel approach that addresses both spiritual and social needs of believers, guiding the ministry's focus on community outreach and empowerment programs alongside spiritual development.</p>
                        
                        <p>He holds a Doctorate in Theology and is committed to training and equipping ministers to effectively serve in various regions. Together with his wife Anne, they continue to lead the church with a vision to establish thriving urban and rural churches in Kenya and beyond.</p>
                    </div>
                </div>
                @endif
            </div>
